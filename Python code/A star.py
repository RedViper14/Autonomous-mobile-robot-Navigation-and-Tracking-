...
img = cv2.imread(r"C:\Users\Hari\Desktop\Project\Map.png")
...
if path is None:
    raise ValueError("No A* path found!")

print("Original A* path found:", path)
...
print("Reduced A* Path:", reduced_path)


# STEP 10: Draw Original A* Graph
...
plt.yticks(np.arange(0, grid_rows + 1, 10))
plt.grid(color='gray', linestyle='--', linewidth=0.5)
plt.title("Original A* Algorithm Waypoints")
...
# STEP 11: Convert Path Grid -> World Coordinates
...
save_path = r"C:\Users\Hari\Desktop\Mobile robotics\Contribution\controllers\samplecontroller\astar_waypoints.npy"
...
# STEP 12: Plot Path in World Coordinates
...
plt.title("Original A* Path in Webots World Coordinates")
plt.legend()
plt.grid(True)
plt.axis("equal")
plt.tight_layout()
